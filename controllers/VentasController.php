    ...
    public function actionAgregarproducto(){
        ...
        if (Yii::$app->request->isAjax) {
            ...
            if ( $modelProducto !== false ) {
                ...
                $response .= '<td>';
                $response .= Html::input('text', 'venta['.$iIdProducto.']['.$indice.'][cantidad]', 1, [ 'id'=> 'cant_'.$indice, 'class' => 'form-control cantidad', 'onblur' => 'javascript:calculartotal( this.value, "'.$iIdProducto.'" )' ]);
